...
if __name__ == '__main__':
    ...
    print('{}	{}	{}	{}	{}	{}	{}	{}		{}'.format('area','unit',('name'+(' '*20))[0:20],'ext','req','san','MNOVM','MNSPA','SVR_NO_C_GR'))
    print('{}	{}	{}	{}	{}	{}	{}	{}		{}'.format('====','====',('===='+(' '*20))[0:20],'===','===','===','=====','=====','==========='))
    for x in rows:
        #print (x.keys())
        #['ac', 'unit', 'name', 'working_unit', 'ext', 'req', 'san', 'MNOVM', 'MNSPA', 'SVR_NO_C_GR']
        print('{}	{}	{}	{}	{}	{}	{}	{}		{}'.format(x['ac'],x['unit'],(x['name']+(' '*20))[0:20],x['ext'],x['req'],x['san'],x['MNOVM'],x['MNSPA'],x['SVR_NO_C_GR']))
        ext = ext + (x['ext'] or 0)
        req = req + (x['req'] or 0)
        san = san + (x['san'] or 0)
    ...
    print('{}	{}	{}	{}	{}	{}	{}	{}		{}'.format('----','----',('total'+(' '*20))[0:20],ext,req,san,MNOVM,MNSPA,SVR_NO_C_GR))
